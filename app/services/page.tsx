      ...
      <div className="mx-auto flex max-w-6xl flex-col items-center">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          {services.map((service, index) => (
            ...
            >
              <div className="absolute inset-0 rounded-xl bg-linear-to-br from-blue-600/5 to-purple-600/5 opacity-0 transition-opacity duration-300 group-hover:opacity-100"></div>
