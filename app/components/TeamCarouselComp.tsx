            ...
            >
              {members.map((member, index) => (
                ...
                >
                  ...
                  >
                    <div
                      className={`bg-linear-to-br px-6 pt-6 pb-2 ${
                        colorVariants[index % colorVariants.length]
                      } rounded-xl`}
                    >
                      <div className="flex flex-col items-center md:flex-row">
                        <div className="relative mb-6 h-32 w-32 shrink-0 md:mr-6 md:mb-0 md:h-40 md:w-40">
                          <div className="absolute inset-0 rounded-full bg-linear-to-br from-blue-500 to-teal-400 p-1">
                        ...
                        <div className="text-center md:text-left">
                          ...
                          <p className="mb-4 text-gray-500">{member.company}</p>
