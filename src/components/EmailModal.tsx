            ...
            {isOpen && (
                ...
                >
                    <motion.div
                        ...
                        className="relative z-[10000] w-full max-w-lg rounded-2xl border border-teal-100/50 p-8 shadow-2xl backdrop-blur-sm transition-all duration-300 hover:scale-[1.01] hover:shadow-2xl dark:border-teal-900/50"
                    >
                        <button
                            onClick={onClose}
