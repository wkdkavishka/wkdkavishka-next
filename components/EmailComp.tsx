...
export const EmailModal: React.FC<EmailModalProps> = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await emailjs.send(
        //! these are sucure keys , but who cares.
        "service_jg2rmtg",
        "template_e1c3rv8",
        templateParams,
        "qz_99WqAXBiP0MXqJ",
      ...
      {isOpen && (
        ...
        >
          <motion.div className="relative w-full max-w-lg rounded-2xl border-2 border-gray-200 bg-white p-8 shadow-xl transition-all duration-300 hover:border-blue-500">
            <div className="pointer-events-none absolute inset-0 rounded-xl bg-linear-to-br from-blue-600/5 to-purple-600/5 opacity-0 transition-opacity duration-300 group-hover:opacity-100"></div>
            <div className="relative z-10">
              ...
              <div className="mb-6">
                <h3 className="mb-3 bg-linear-to-r from-teal-600 to-purple-600 bg-clip-text text-3xl font-bold text-transparent">
                  Send a Message
                </h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="flex gap-x-4">
                  <label className="inline-flex cursor-pointer items-center">
                    ...
                    />
                    <div className="peer relative h-6 w-11 rounded-full peer-checked:bg-blue-600 peer-focus:ring-4 peer-focus:ring-blue-300 peer-focus:outline-none after:absolute after:start-0.5 after:top-0.5 after:h-5 after:w-5 after:rounded-full after:border after:border-gray-300 after:bg-white after:transition-all after:content-[''] peer-checked:after:translate-x-full peer-checked:after:border-white rtl:peer-checked:after:-translate-x-full" />
                    <span className="ms-3 text-sm text-gray-600">
                      By selecting this, you agree to our{" "}
                      {/* //todo: set later */}
                      {/** biome-ignore lint/a11y/useValidAnchor: to set later */}
                ...
                <button
                  ...
                  className="flex w-full items-center justify-center rounded-xl bg-linear-to-r from-blue-600 to-purple-600 px-6 py-3 text-white transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
                >
                  {isSubmitting ? (
                    "Sending..."
                  ) : (
